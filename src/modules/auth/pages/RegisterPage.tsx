...
const RegisterPage: React.FC = () => {
  ...
  const roleInfo: Record<string, { title: string; desc: string }> = {
    BUYER:  { title: 'Buyer account', desc: 'Browse, cart, and order books from verified sellers.' },
    SELLER: { title: 'Seller account', desc: 'List your books, manage inventory, and ship orders. Your shop will be reviewed within 24h.' },
  }
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.leftPanel}>
        ...
        <Typography variant="h1Bold" style={{ marginBottom: 16, letterSpacing: '-0.03em' }}>
          Join BookBazaar
        </Typography>
        <Typography variant="bodyLarge" color="secondary" style={{ maxWidth: 340, marginBottom: 48 }}>
          Start your journey — as a reader discovering new worlds, or a seller sharing your collection.
        </Typography>
        ...
        {['BUYER', 'SELLER'].map((role) => (
          <div
            ...
            style={{
              ...styles.roleCard,
              borderColor: selectedRole === role ? colors.primary : 'transparent',
              background: selectedRole === role ? colors.primaryLight : '#f5f5f7',
            }}
          >
            <Typography variant="label" style={{ color: selectedRole === role ? colors.primary : '#1d1d1f' }}>
      ...
      <div style={styles.rightPanel}>
        <div style={styles.formCard}>
          ...
          <Typography variant="bodyMedium" color="secondary" style={{ marginBottom: 32 }}>
            Already have one?{' '}
            <Link to={ROUTES.LOGIN} style={{ color: colors.primary }}>Sign in</Link>
          </Typography>
          ...
          >
            ...
            >
              <Input size="large" placeholder="Rajat Mathur" style={styles.input} />
            </Form.Item>
            ...
            >
              <Input size="large" placeholder="you@example.com" style={styles.input} />
            </Form.Item>
            ...
            >
              <Input.Password size="large" placeholder="Min. 8 characters" style={styles.input} />
            </Form.Item>
            ...
            >
              <Input.Password size="large" placeholder="Repeat password" style={styles.input} />
            </Form.Item>
            ...
            >
              <Select size="large" style={styles.input}>
                <Select.Option value="BUYER">Buyer — I want to shop for books</Select.Option>
                <Select.Option value="SELLER">Seller — I want to sell books</Select.Option>
              </Select>
            </Form.Item>
